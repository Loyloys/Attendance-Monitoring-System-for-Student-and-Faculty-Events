    ...
    <div className="min-h-screen bg-[#FFFBEB] flex flex-col overflow-hidden">
      ...
      */}
      ...
      <div className="relative flex flex-1 overflow-hidden">
        {/* 2. The Glass Sidebar 
            In the 2026 COT UI, this component is backdrop-blurred and 
        ...
        */}
        <main className="flex-1 relative overflow-y-auto lg:rounded-tl-[40px] bg-white shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)] border-t border-l border-slate-200/50 transition-all duration-500">
          ...
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#F97316]/5 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#EA580C]/5 rounded-full blur-[80px] pointer-events-none" />
